...
Winsock2 (Windows Sockets API v2) is used to implement a TCP server that accepts HTTP connections and upgrades them to the WebSocket protocol (RFC 6455 \cite{fette2011}). The upgrade involves:
\begin{enumerate}
